        ...
        <div class="py-12">
            <div class="mx-auto max-w-7xl sm:px-6 lg:px-8">
                <div class="overflow-hidden bg-white shadow-sm sm:rounded-lg">
					<div class="container p-4 mx-auto my-32 md:p-0">
							...
							<div class="w-full bg-white md:w-1/2">
								<div class="relative h-full px-6 mx-auto md:px-0 md:pt-6 md:-ml-6">
									<div class="relative flex flex-wrap items-center p-6 mb-4 -mt-6 bg-white lg:h-full md:mt-0 md:mb-0 md:flex-wrap">
										<div class="w-full text-center lg:px-3 lg:border-right lg:border-solid md:text-left">
											...
											<p class="mt-3 mb-0 text-sm italic text-grey-dark">produced by: {{ state.movie.properties.producer}}</p>
										...
										<div class="w-full mt-6 text-center lg:px-4 md:text-left">
											<Link :href="route('db.films.index')" class="w-2/3 px-4 py-2 bg-white border border-solid hover:bg-grey-darker hover:font-black border-grey lg:w-full">
												Back to overview
											</Link>
										</div>
									</div>
...
<script>
	...
	export default {
		...
		setup(props) {
			...
			return { state, authUser,  goToOverview}
		}
	}
</script>